...
public class StringUtil {
    ...
    public static BigInteger toBigInteger(String str, BigInteger def) {
        ...
        try {
            result = BigInteger.valueOf(Long.parseLong(str));
        } catch (Exception e) {
            return result;
        }
        return result;
    ...
    public static boolean isBooleanType(String str) {
        ...
        if (null == tmpStr) {
            return false;
        } else if ("true".equalsIgnoreCase(tmpStr) || "false".equalsIgnoreCase(tmpStr)) {
            return true;
        } else {
            return false;
        }
    ...
    public static boolean containSubStr(String str, String[] strList) {
        ...
        if (strList.length == 0 || (str == null || str.length() == 0)) {
            return containSub;
        }
     ...
     * @author
     */
    public static boolean matcherStr(String str, String regNx) {
        if (null == str) {
            return false;
        }
        return Pattern.matches(regNx, str);
    }
...
//        String result = "";
    ...
    public static String removeLastStr(String str, String lastStr) {
        if (str != null && str.length() > 0 && lastStr != null && lastStr.length() > 0) {
